...
class Company {
   ...
   * logoUrl }, ...] for companies whose name contains name value,
   * and/or number of employees defined by min/maxEmployees 
   * */
  ...
  static async findAll (params) {
    ...
    if (params.name != "%undefined%") {
      ...
      if (params.minEmployees) {
        ...
        parameters.push(params.minEmployees);
        if (params.maxEmployees) {
          whereClause += `AND num_employees <= $3 `;
          parameters.push(params.maxEmployees);
        }
      }
      else {
        if (params.maxEmployees) {
