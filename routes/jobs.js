...
router.post("/jobs", isAdmin, async function (req, res, next) {
  try {
...
router.patch("/jobs/:id", isAdmin, async function (req, res, next) {
  try {
...
router.delete("/jobs/:id", isAdmin, async function (req, res, next) {
  try {
