...
router.post("/companies", isAdmin, async function (req, res, next) {
  try {
...
router.patch("/companies/:handle", isAdmin, async function (req, res, next) {
  try {
...
router.delete("/companies/:handle", isAdmin, async function (req, res, next) {
  try {
